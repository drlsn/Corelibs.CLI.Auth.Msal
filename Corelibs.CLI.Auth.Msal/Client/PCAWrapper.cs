...
namespace Corelibs.CLI.Auth.Msal
{
    ...
    /// </summary>
    internal class PCAWrapper : IPCAWrapper
    {
        private readonly IConfiguration _configuration;
        private readonly MsalClientSettings _settings;
        ...
        public PCAWrapper(IConfiguration configuration)
        {
            ...
            _settings = _configuration.GetRequiredSection("MsalClientSettings").Get<MsalClientSettings>();
